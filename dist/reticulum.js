...
var Reticulum = function () {
    ...
    var initiate = function initiate(camera, options) {
        //Update Settings:
        options = options || {};
    ...
    var detectHit = function detectHit() {
        try {
    ...
    var setColor = function setColor(threeObject, color) {
        threeObject.material.color.setHex(color);
    };

    var gazeOut = function gazeOut(threeObject) {
    ...
    var gazeOver = function gazeOver(threeObject) {
    ...
    var gazeLong = function gazeLong(threeObject) {
        var distance;
    ...
    var gazeClick = function gazeClick(threeObject) {
    ...
    var touchClickHandler = function touchClickHandler(e) {
    ...
    return {
        add: function add(threeObject, options) {
            var parameters = options || {};
        ...
        remove: function remove(threeObject) {
        ...
        init: function init(camera, options) {
            var c = camera || null;
            var o = options || {};
